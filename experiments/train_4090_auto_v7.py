...
INJECTION_CUTOFF_LAYER = 25  # 仅在前段层注入空间条件，后段保留生成自由度
INJECTION_STRATEGY = "front_dense"  # 0-14 dense, 15-24 sparse, 25+ off
...
USE_LQ_INIT = False
INIT_NOISE_STD = 0.0
LQ_INIT_STRENGTH = 0.0  # 0~1, start from this noise level when using LQ-init
USE_CFG_TRAIN = False
CFG_TRAIN_SCALE = 3.0
