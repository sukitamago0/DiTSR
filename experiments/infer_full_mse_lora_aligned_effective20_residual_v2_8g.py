...
def main():
    ...
    parser.add_argument("--no_lpips", action="store_true", help="disable LPIPS computation")
    ...
    print(
        f"[Config] residual_mode={RESIDUAL_MODE} | vae_on_cpu={bool(args.vae_on_cpu)} | "
        f"lpips_on_cpu={bool(args.lpips_on_cpu)} | no_lpips={bool(args.no_lpips)}"
    )
