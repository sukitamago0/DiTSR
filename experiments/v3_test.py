...
SAVE_INTERVAL = 50      
SDE_STRENGTH = 0.45
TEXTURE_LOSS_WEIGHT = 0 # [新增] 纹理损失权重，推荐 0.1
USE_TEXTURE_LOSS = False
LOG_PATH = "./experiments_results/overfit_hybrid_v4_newlatent_sde0.45/train.log"
# ===========================================
...
def run_hybrid_experiment():
    ...
    plt.figure(figsize=(10, 5))
    plt.plot(losses)
    plt.savefig("./experiments_results/overfit_hybrid_v4_newlatent_sde0.45/loss.png")

def evaluate_and_save(model, adapter, vae, lr_latent_input, lr_img, y_embed, data_info, step, hr_img_gt, hr_latent):
    model.eval(); adapter.eval()
    save_dir = "./experiments_results/overfit_hybrid_v4_newlatent_sde0.45/vis"
    os.makedirs(save_dir, exist_ok=True)
