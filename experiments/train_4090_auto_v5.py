# /home/hello/HJT/DiTSR/experiments/train_4090_auto_v5.py
# DiTSR v5 Training Script
...
OUT_DIR = os.path.join(PROJECT_ROOT, "experiments_results", "train_4090_auto_v5")
...
def main():
    ...
    adapter = build_adapter("fpn_v6", 4, 1152).to(DEVICE).float().train()
